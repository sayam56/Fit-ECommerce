               ...
               <div class="header__top__right">
                   <div class="header__top__right__auth">
                       ...
                       <?php
                        ...
                        ?>
                           <a href="logout.php">Welcome <?php echo $username ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <div class="col-lg-6" style="padding-left: 50px;">
                       <nav class="header__menu">
                           <ul>
                               ...
                               <li><a href="http://localhost/Clean_food_healthy_life_ecom/index.php">Shop Homepage</a></li>
                               <li><a href="../Chat/index.php">Consultation</a></li>
